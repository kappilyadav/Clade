  ...
  return (
    <main className="flex text-black bg-white min-h-screen flex-col items-center overflow-hidden">
      <div id="subheader" className="mt-32 md:mt-24 flex items-center gap-6 md:gap-12 px-20 justify-center md:justify-normal w-full border-b border-gray-300 bg-white">
        <button className="text-primary font-bold py-4 border-b-2 border-primary">Job preview</button>
      ...
      <div id="content" className="grid grid-cols-12 w-full">
        ...
        <div className="col-span-12 lg:col-span-3 bg-gray-100 bg-opacity-30 border-l border-gray-300 px-20 lg:px-8">
          <div className="flex items-center justify-center gap-x-2 py-8">
            <button className="flex w-1/2 items-center justify-center gap-x-1 bg-orange-100 text-primary text-sm text-nowrap border border-primary rounded-md px-6 py-2">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4">
                <path strokeLinecap="round" strokeLinejoin="round" d="m14.74 9-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 0 1-2.244 2.077H8.084a2.25 2.25 0 0 1-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 0 0-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 0 1 3.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 0 0-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 0 0-7.5 0" />
              </svg>
              Delete job
            </button>
            <button className="flex w-1/2 items-center justify-center gap-x-1 bg-primary text-white text-sm text-nowrap border border-primary rounded-md px-6 py-2">
