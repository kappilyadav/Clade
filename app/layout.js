    ...
    <html lang="en">
      <body className={inter.className}>
        <nav id="header" className="fixed z-10 w-full">
          <div className="flex justify-between items-center px-10 h-24 w-full border-b border-gray-300 bg-white">
            <a href="/" className="flex text-center gap-2 text-orange-600 text-base font-semibold">
              ...
              <p className="text-orange-600 text-2xl font-bold">Jobzy</p>
            </a>
            <div className="flex items-center gap-8 border border-gray-300 rounded-full p-2">
              <button onClick={() => push('/')} className={`flex items-center text-gray-500 gap-x-1 text-sm p-2 ${pathname === '/' && 'bg-orange-600 border-2 border-orange-300 rounded-full text-white'}`}>
