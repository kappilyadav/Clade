        ...
        <div className="pt-24 flex h-screen antialiased text-gray-800">
            <div className="flex flex-row h-full w-full overflow-x-hidden">
                <div className="flex flex-col py-8 pl-6 pr-2 w-64 bg-white flex-shrink-0">
                    ...
                    <div className="font-bold text-2xl">Your Messages</div>
                    </div>
                    <div
                    className="flex flex-col items-center bg-gray-100 border border-gray-200 mt-4 w-full py-6 px-4 rounded-lg"
                    >
                    <div className="flex items-center justify-center text-white text-3xl h-20 w-20 rounded-full border-2 border-gray-300 overflow-hidden">
                        <UserAvatar height={100} width={100}/>
                    </div>
                    <div className="text-sm font-semibold mt-2">Kapil Yadav</div>
                    <div className="text-xs text-gray-500">Full Stack Engineer</div>
                    <div className="flex flex-row items-center mt-3 border bg-green-200 border-green-600 rounded-full py-1 px-2">
                    ...
                    <div className="flex flex-row items-center justify-between text-xs">
                        ...
                        <span
                        className="flex items-center text-xs text-gray-700 font-semibold justify-center bg-gray-300 h-4 w-4 rounded-full"
                        >4</span
                        >
                    </div>
                    <div className="flex flex-col space-y-1 mt-4 -mx-2 overflow-y-auto">
                        <button
                        className="flex flex-row items-center bg-gray-200 rounded-xl p-2"
                        >
                        <div
                            className="flex items-center justify-center h-8 w-8 text-white rounded-full"
                        >
                            <UserAvatar height={10} width={10} />
                        </div>
                        <div className="ml-2 text-sm font-semibold">Kapil Yadav</div>
                        </button>
                        <button
                        ...
                        <div className="ml-2 text-sm font-semibold">Harsh Agrawal</div>
                        <div
                        ...
                        <div className="ml-2 text-sm font-semibold">Parik S</div>
                        </button>
                        <button
                        className="flex flex-row items-center hover:bg-gray-100 rounded-xl p-2"
                        >
                        ...
                        <div className="ml-2 text-sm font-semibold">Matthew Lesiuk</div>
                        </button>
                    </div>
                    </div>
                </div>
                <div className="flex flex-col flex-auto h-full p-6">
                    ...
                    <div className="flex flex-col h-full overflow-x-auto mb-4">
                        ...
                        <div className="grid grid-cols-12 gap-y-2">
                            ...
                            <div className="flex flex-row items-center">
                                <div
                                className="flex items-center justify-center h-10 w-10 rounded-full text-white flex-shrink-0"
                                >
                                    <UserAvatar height={10} width={10} />
                                </div>
                                <div
                    ...
                    >
                        ...
                        <div className="relative w-full">
                            <input
                            type="text"
                            className="flex w-full border rounded-xl focus:outline-none focus:border-gray-300 pl-4 h-10"
                            />
                            <button
